...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Zed-Vela-Dev",
        ReleaseChannel::Nightly => "Zed-Vela-Nightly",
        ReleaseChannel::Preview => "Zed-Vela-Preview",
        ReleaseChannel::Stable => "Zed-Vela-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Zed Vela",
            ReleaseChannel::Nightly => "Zed Vela Nightly",
            ReleaseChannel::Preview => "Zed Vela Preview",
            ReleaseChannel::Stable => "Zed Vela",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.zed-vela.Zed-Vela-Dev",
            ReleaseChannel::Nightly => "dev.zed-vela.Zed-Vela-Nightly",
            ReleaseChannel::Preview => "dev.zed-vela.Zed-Vela-Preview",
            ReleaseChannel::Stable => "dev.zed-vela.Zed-Vela",
        }
    }
